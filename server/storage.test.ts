...
import type { InsertAccount, InsertDraft, InsertPost, InsertUser } from '../shared/schema'
...
describe('MemStorage', () => {
  ...
  describe('Account methods', () => {
    ...
    it('should update an account', async () => {
      ...
      const retrievedAccount = (await storage.getAccounts(1)).find((acc) => acc.id === accountToUpdate.id)
