...
import { mockPlatforms, renderWithProviders } from '../../../test/test-utils'
...
describe('PlatformCard component', () => {
  ...
  it('should render the platform card', () => {
    renderWithProviders(<PlatformCard platform={mockPlatform} charCount={100} active={true} onToggle={mockToggle} />)
  ...
  it('should display different styles based on active state', () => {
    ...
    const { rerender } = renderWithProviders(
      <PlatformCard platform={mockPlatform} charCount={100} active={true} onToggle={mockToggle} />
    )
    ...
    rerender(<PlatformCard platform={mockPlatform} charCount={100} active={false} onToggle={mockToggle} />)
  ...
  it('should display a warning when character count exceeds the limit', () => {
    ...
    renderWithProviders(
      <PlatformCard platform={mockPlatform} charCount={charCount} active={true} onToggle={mockToggle} />
    )
