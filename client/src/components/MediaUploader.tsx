...
export function MediaUploader({ mediaFiles, isPendingUpload, onUpload, onRemove }: MediaUploaderProps) {
    ...
    >
      {mediaFiles.length === 0 ? (
        <div className="text-center" id="uploadPrompt">
          ...
          <Button type="button" variant="outline" size="sm" onClick={handleUploadClick} disabled={isPendingUpload}>
