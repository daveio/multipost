import { type ThemeMode as ModeType, type CatppuccinTheme as ThemeType, createTheme } from '@/lib/theme-utils'
...
export function CatppuccinThemeProvider({ children, defaultTheme = 'mocha' }: ThemeProviderProps) {
