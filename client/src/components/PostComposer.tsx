...
import { type AdvancedOptions, type CharacterStat, type MediaFile, Platform, type ThreadPost } from '../types'
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <Accordion type="single" collapsible className="mb-6 border rounded-lg">
          <AccordionItem value="advanced-options">
            <AccordionTrigger className="px-4 py-3 text-md font-medium">Advanced Options</AccordionTrigger>
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-gray-200 pt-4 mt-4">
                  ...
                  <div className="flex items-center space-x-4 mb-4">
                    <div
                      id="mastodonLimitContainer"
                      className={`grid gap-1.5 leading-none flex-1 p-2 ${localStorage.getItem('customMastodonLimit') !== null ? 'local-storage-setting' : ''}`}
                    >
                      <label htmlFor="mastodonCharLimit" className="text-sm font-medium leading-none">
                      ...
                      <div className="flex items-center mt-2 gap-2">
                        <div className="relative">
                          ...
                          />
                          <div
                            className="absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none opacity-0 transition-opacity"
                            id="savedIndicator"
                          >
                            <svg
                ...
                <div className="border-t border-gray-200 pt-4 mt-4">
                  ...
                  <div
                    className={`flex items-start space-x-2 p-2 ${localStorage.getItem('showRawJson') !== null ? 'local-storage-setting' : ''}`}
                  >
                    <Checkbox
                      id="showRawJson"
                  ...
                  <div
                    className={`flex items-start space-x-2 p-2 mt-2 ${localStorage.getItem('showReasoning') !== null ? 'local-storage-setting' : ''}`}
                  >
                    <Checkbox
                      id="showReasoning"
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <Button type="button" variant="ghost" onClick={onResetForm} disabled={isPendingDraft || isPendingPost}>
              <UIIcon.Undo className="mr-1 h-4 w-4" /> Reset
            </Button>
            <Button type="submit" disabled={!isFormValid || isPendingDraft || isPendingPost}>
