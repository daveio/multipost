...
import { SplitPostResult, SplittingStrategy, optimizePost, splitPost } from './aiService'
...
describe('AI Service', () => {
  ...
  describe('splitPost', () => {
    const mockContent =
      'This is a long post that needs to be split into multiple parts for social media. It should respect the character limits of different platforms and maintain the meaning of the original post.'
    ...
    it('should handle API errors gracefully', async () => {
      ...
      await expect(splitPost(mockContent, mockStrategies)).rejects.toThrow('API rate limit exceeded')
    })
    ...
    it('should handle network errors', async () => {
      ...
      await expect(splitPost(mockContent, mockStrategies)).rejects.toThrow('Network error')
    })
  })
  ...
  describe('optimizePost', () => {
    ...
    it('should handle API errors with a clear message', async () => {
      ...
      await expect(optimizePost(mockContent, mockPlatform)).rejects.toThrow('Invalid API key provided')
    })
    ...
    it('should handle non-JSON error responses', async () => {
      ...
      await expect(optimizePost(mockContent, mockPlatform)).rejects.toThrow('Server error')
    })
  })
